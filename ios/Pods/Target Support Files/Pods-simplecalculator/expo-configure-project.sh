...
with_node \
  ...
  --target "/Users/chandanbsd/dev/simple-calculator/ios/Pods/Target Support Files/Pods-simplecalculator/ExpoModulesProvider.swift" \
  --entitlement "/Users/chandanbsd/dev/simple-calculator/ios/simplecalculator/simplecalculator.entitlements" \
  --platform "apple" \
